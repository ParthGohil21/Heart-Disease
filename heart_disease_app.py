...
st.sidebar.info(f'''
         ...
         This model is trained on the data of over **500K patients with model accuracy of 96%** 🩺💓''') 
...
SleepTime=st.selectbox('On average, how many hours of sleep do you get in a 24-hour period?',
              [ 7.0,  8.0,  6.0,  5.0,  9.0, 10.0,  4.0, 12.0,  3.0,  2.0,  1.0,
              11.0, 14.0, 16.0, 15.0, 18.0, 13.0, 20.0, 24.0, 17.0, 22.0, 19.0,
              23.0, 21.0])
...
def make_classification():
   ...
   if prediction==1:
      return st.error('You are more likely to have heart disease ☹️!! - Dr. Radnom Forest')

   elif prediction==0:
      return st.success('You are not likely to have heart disease 🥳!! - Dr. Radnom Forest')
